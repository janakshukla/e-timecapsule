  ...
  return (
    <div className="flex mt-16 items-center lg:gap-36 min-h-[80dvh] md:pt-16 lg:px-36">
      <div className="md:grid grid-cols-6 h-full w-full text-white grid-rows-7 gap-4">
        <div className="col-span-4 row-span-2 p-4  rounded-md shadow-lg ">
        ...
        <div className="col-span-2 row-span-2 col-start-5 p-4  rounded-md shadow-lg ">
          {" "}
        ...
        <div className="col-span-2 row-span-3 row-start-3 p-4  rounded-md shadow-lg ">
          {" "}
        ...
        <div className="col-span-2 row-span-2 col-start-3 p-4  rounded-md shadow-lg row-start-3  ">
        ...
        <div className="col-span-2 row-span-3 col-start-3 row-start-5 p-4  rounded-md shadow-lg ">
        ...
        <div className="col-span-2 row-span-2 col-start-1 row-start-6 p-4  rounded-md shadow-lg  ">
        ...
        <div className="col-span-2 row-span-5 col-start-5 row-start-3 p-4  rounded-md shadow-lg  ">
