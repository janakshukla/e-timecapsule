              ...
              <div>
                {isOpen && (
                  <div className="  text-white p-4">
                    <Link href="/" onClick={() => setIsOpen(false)} className="block py-2 hover:text-blue-400">
                      Home
                    </Link>
                    <Link href="/dashboard" onClick={() => setIsOpen(false)} className="block py-2 hover:text-blue-400">
                      Dashboard
                    </Link>
                    <Link href="/alluser" onClick={() => setIsOpen(false)} className="block py-2 hover:text-blue-400">
                      All Users
                    </Link>
                  </div>
                )}
